 ...
 * Use the [ChatDokterFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChatDokterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chat_dokter, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ChatDokterFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChatDokterFragment().apply {
